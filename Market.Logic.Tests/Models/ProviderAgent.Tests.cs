...
public class ProviderAgentTests
{
    ...
    public void CanBeCreated()
    {
        ...
        var user = new User(new InternalID(1), "login1", new Password("12345678"), "mail@mail.ru", UserType.Agent);
    ...
    public void CanNotCreateWhenUserIsNotAgent()
    {
        ...
        var provider = new Provider(
            ...
            new Margin(1.1m),
            new PaymentTransactionsInformation("1234567890", "01234012340123401234"));
        var user = new User(new InternalID(1), "login1", new Password("12345678"), "mail@mail.ru", UserType.Customer);
    ...
    public void CanNotCreateWithoutProvider()
    {
        // Act
        var exception = Record.Exception(() => _ = new ProviderAgent(
            agent: new User(new InternalID(1), "login1", new Password("12345678"), "mail@mail.ru", UserType.Agent),
            provider: null!));
